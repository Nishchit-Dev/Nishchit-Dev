...
🚀 Creator of **CardBoardAI** **Pomogo**, **SpeedScript**, **LovableLabs**, and **Invisiblenote**.  
...
- Building scalable backends with Supabase + Go ⚙️  
- Open-source tools that blend **code × creativity × curiosity** ✨  
